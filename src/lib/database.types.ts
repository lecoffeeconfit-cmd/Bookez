...
export type Database = {
  bookez: {
    Tables: {
      ...
      community_project_views: {
        Row: { project_id: string; viewer_id: string; first_viewed_at: string; last_viewed_at: string };
        Insert: { project_id: string; viewer_id: string; first_viewed_at?: string; last_viewed_at?: string };
        Update: { project_id?: string; viewer_id?: string; first_viewed_at?: string; last_viewed_at?: string };
        Relationships: [{ foreignKeyName: 'community_project_views_project_id_fkey'; columns: ['project_id']; isOneToOne: false; referencedRelation: 'projects'; referencedColumns: ['id'] }];
      };
      community_presence: {
      ...
      community_feedback_requests: {
        ...
        Update: { id?: string; user_id?: string; project_id?: string; project_title?: string; author_display_name?: string; genre?: string | null; completion_percent?: number | null; stage?: string | null; cover_image_path?: string | null; focus?: string; question?: string | null; content_scope?: string; content_snapshot?: Json; selected_word_count?: number; reading_minutes?: number; listening_minutes?: number; selected_item_count?: number; focuses?: Json; custom_question?: string | null; author_visibility?: string; reading_enabled?: boolean; listening_enabled?: boolean; passage_comments_enabled?: boolean; general_feedback_enabled?: boolean; public_comments_enabled?: boolean; response_visibility?: string; response_limit?: number | null; closes_at?: string | null; status?: string; updated_at?: string };

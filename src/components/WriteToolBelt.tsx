...
const topTools: WriteToolDefinition[] = [
  ...
  { id: 'make-clearer', name: 'Make Clearer', shortName: 'Clearer', belt: 'top', availableIn: ['top'], icon: '◇', color: '#729BB7', description: 'Improve clarity without flattening your voice.', howToUse: 'Use Make Clearer when you understand the idea but worry a reader may not.', example: 'Clarify what “it” refers to in a dense paragraph.' },

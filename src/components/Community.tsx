...
export type CommunityProps = { userId: string | null; activeProject?: CommunityProject; projects?: CommunityProject[]; onSelectProject?: (title: string) => void };
...
export default function Community({ userId, activeProject, projects = [], onSelectProject }: CommunityProps) {
  ...
  useEffect(() => { void loadPreferences(); void loadFeed(); }, [userId]);
...
const s = StyleSheet.create({
  ...
  cardFooter: { marginTop: 8, paddingTop: 9, borderTopWidth: 1, borderTopColor: '#F0EEF5', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, reactionTotals: { flex: 1, color: '#9194AC', fontSize: 7 }, reactionActions: { flexDirection: 'row', gap: 5 }, reactionButton: { width: 25, height: 25, borderRadius: 8, backgroundColor: '#F3F1FA', alignItems: 'center', justifyContent: 'center' }, reactionButtonActive: { backgroundColor: '#E8E3FF' }, reactionIcon: { color: C.muted, fontSize: 12 }, reactionIconActive: { color: C.periwinkle },

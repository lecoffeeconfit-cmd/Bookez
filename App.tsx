...
const s: any = Object.assign(StyleSheet.create({
  ...
  planStepCardAesthetic: { marginTop: 18, padding: 20, borderRadius: 27, backgroundColor: 'rgba(255,255,255,0.9)', borderWidth: 1, borderColor: 'rgba(226,224,242,0.9)', shadowColor: '#6E6A91', shadowOpacity: 0.08, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 3 }, planSectionKickerAesthetic: { color: C.periwinkle, fontSize: 8, letterSpacing: 1.15, fontWeight: '700' }, planSectionTitleAesthetic: { color: C.ink, fontSize: 25, lineHeight: 30, letterSpacing: -0.7, fontWeight: '700', marginTop: 7 }, planSectionCopyAesthetic: { color: C.muted, fontSize: 11, lineHeight: 17, marginTop: 8 }, metricRowAesthetic: { flexDirection: 'row', gap: 12, marginTop: 18 }, metricCardAesthetic: { flex: 1, padding: 16, borderRadius: 21, backgroundColor: '#F8F5FF', borderWidth: 1, borderColor: '#E9E4FA', shadowColor: '#837CB0', shadowOpacity: 0.05, shadowRadius: 9, shadowOffset: { width: 0, height: 4 }, elevation: 1 }, metricLabelAesthetic: { color: '#767CA2', fontSize: 8, letterSpacing: 1, fontWeight: '700' }, metricInputAesthetic: { color: C.ink, fontSize: 32, lineHeight: 38, fontWeight: '700', paddingVertical: 5, paddingHorizontal: 0 }, metricHintAesthetic: { color: C.muted, fontSize: 9, lineHeight: 13, marginTop: 1 }, planTipAesthetic: { marginTop: 14, paddingVertical: 11, paddingHorizontal: 14, borderRadius: 17, backgroundColor: '#FFF7DE', borderWidth: 1, borderColor: '#F2E2B7', shadowColor: '#B48A38', shadowOpacity: 0.06, shadowRadius: 9, shadowOffset: { width: 0, height: 4 }, elevation: 1 }, planTipMainRow: { flexDirection: 'row', alignItems: 'center' }, planTipIconAesthetic: { color: '#C9901B', fontSize: 15, marginRight: 9 }, planTipTextAesthetic: { flex: 1, color: '#8C6B29', fontSize: 10, lineHeight: 15 }, planTipWhyButton: { minHeight: 28, minWidth: 43, paddingHorizontal: 7, borderRadius: 9, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.52)' }, planTipWhyText: { color: '#A97819', fontSize: 9, fontWeight: '700' }, planTipExpandedText: { color: '#8C6B29', fontSize: 9, lineHeight: 13, marginLeft: 24, marginTop: 7 }, primaryMetricCardAesthetic: { position: 'relative', overflow: 'hidden', marginTop: 17, padding: 16, borderRadius: 23, borderWidth: 1.5, borderColor: '#DFD8FF', shadowColor: '#766DB4', shadowOpacity: 0.1, shadowRadius: 15, shadowOffset: { width: 0, height: 7 }, elevation: 3 }, primaryMetricAccent: { position: 'absolute', width: 128, height: 128, borderRadius: 64, right: -52, top: -58, backgroundColor: 'rgba(255,255,255,0.42)' }, primaryMetricHeaderAesthetic: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }, primaryMetricTitleAesthetic: { color: C.ink, fontSize: 18, letterSpacing: -0.2, fontWeight: '700', marginTop: 5 }, primaryMetricUnitPill: { paddingHorizontal: 9, paddingVertical: 5, borderRadius: 9, backgroundColor: 'rgba(255,255,255,0.58)', borderWidth: 1, borderColor: 'rgba(139,138,232,0.16)' }, primaryMetricUnitAesthetic: { color: C.periwinkle, fontSize: 7, letterSpacing: 1, fontWeight: '700' }, primaryMetricInputAesthetic: { color: C.ink, fontSize: 42, lineHeight: 48, letterSpacing: -1.2, fontWeight: '700', paddingVertical: 3, paddingHorizontal: 0 }, primaryMetricHintAesthetic: { color: '#73789D', fontSize: 10, lineHeight: 15 }, scopeExampleAesthetic: { color: '#9699AF', fontSize: 9, lineHeight: 14, marginTop: 8 }, scopeStatsRowAesthetic: { marginTop: 11, paddingTop: 10, borderTopWidth: 1, borderTopColor: 'rgba(139,138,232,0.16)', flexDirection: 'row', alignItems: 'stretch' }, scopeStatAesthetic: { flex: 1, minWidth: 0 }, scopeStatDividerAesthetic: { width: 1, marginHorizontal: 12, backgroundColor: 'rgba(139,138,232,0.16)' }, scopeStatLabelAesthetic: { color: '#767CA2', fontSize: 7, letterSpacing: 0.8, fontWeight: '700' }, scopeStatValueAesthetic: { color: C.ink, fontSize: 22, lineHeight: 26, fontWeight: '700', marginTop: 3 }, scopeStatInputAesthetic: { color: C.ink, fontSize: 22, lineHeight: 26, fontWeight: '700', height: 30, paddingVertical: 0, paddingHorizontal: 0, marginTop: 1 }, scopeStatHintAesthetic: { color: '#878BA7', fontSize: 8, lineHeight: 12, marginTop: 2 }, scopeControlCardAesthetic: { marginTop: 16, padding: 16, borderRadius: 22, backgroundColor: '#FFF', borderWidth: 1, borderColor: '#E8E7F1', shadowColor: '#777292', shadowOpacity: 0.04, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 1 },
